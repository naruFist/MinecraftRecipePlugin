...
fun Plugin.add3x3recipe(a: ItemStack?, b: ItemStack?, c: ItemStack?,
                        ...
                        result: ItemStack, num: Int): ShapedRecipe {
    var shape1 = "abc"
    var shape2 = "def"
    var shape3 = "ghi"
    ...
    return ShapedRecipe(NamespacedKey(this, "$num"),
...
//        }
        ...
        * ㅁㅁㅁㅁㅁㅁㅁㅁㅁ
        * */
        slot(11, ItemStack(Material.CRAFTING_TABLE).apply {
            editMeta {
        ...
        slot(15, ItemStack(Material.CRAFTING_TABLE).apply {
            editMeta {
                ...
                if (inv.getItem(it) != null) {
                    ...
                    plugin.server.addRecipe(
                        plugin.add3x3recipe(inv.getItem(2),inv.getItem(3),inv.getItem(4),
                            ...
                            inv.getItem(recipeResult)!!, number)
                    )

                    // type = 3
                    recipeConfig.set("$number.type", 3)
                    for (j in 0 until 3 * 3) {
        ...
        slot(26, ItemStack(Material.EMERALD_BLOCK).apply {
            ...
            recipeList.forEach {
                if (inv.getItem(it) != null) {
                    ...
                    // type = 4
                    recipeConfig.set("$number.type", 4)
                    for (i in 0 until 9) {
